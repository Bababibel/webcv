...
const source: SourceT = {
  fr: {
    ...
    investItem1: "Auto-entreprenariat en mentorat et conseil informatique",
    investItem2:
      "Auto-hébergement de services personnels (site web, domotique, proxmox...)",
    investItem3:
      "Développement & déploiement d'une application mobile d'automatisation de processus industriels",
    investItem4: "10+ ans de batterie, prestations sur scène et en orchestre",
    linksTitle: "Liens",
  ...
  en: {
    ...
    investItem1: "Self-entrepreneur for I.T. mentoring and consulting",
    investItem2:
      "Self-hosting personal services (website, home automation, proxmox...)",
    investItem3:
      "Mobile application development & deployment for industrial process automation",
    investItem4: "Drummer for 10+ years, multiple shows on stage & orchestra",
    linksTitle: "Links",
    ...
    <nav className="flex flex-col justify-evenly bg-background-secondary w-[38%] p-2">
      <div
        className={`flex flex-col items-center gap-2 ${
          isPictureDisplayed ? "block" : "hidden"
        }`}
      >
      ...
      <div className="blocInfo">
        ...
        <a
          href="mailto:contact@bgauthier.fr"
      ...
      <div className="blocInfo">
        ...
        <ul className="ml-1">
          ...
          <li>{getText(source, "investItem4")}</li>
        </ul>
      </div>
      ...
      <div>
        ...
        <div className="flex mt-2">
          <a
            href="https://www.linkedin.com/in/baptiste-gauthier-cybersecurity/"
            target="_blank"
            className="w-1/6 hover:border-none hover:scale-110"
            title={getText(source, "linksLinkedin")}
          >
