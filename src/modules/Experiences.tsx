...
const source: SourceT = {
  fr: {
    ...
    hsTitle2: ", Tours (37)",
    hsItem1:
      "Poste opérationel dans une équipe EMEA (Europe, Moyen-Orient et Afrique)",
    hsItem2: "Gestion technique d'une crise cyber majeure internationale",
    hsItem3:
      "Mise en place et gestion d'outils de sécurité (EDR, DLP, NAC, VMS...) pour 6000+ utilisateurs",
    hsItem4:
      "Coordinateur et passerelle technique pour le déploiement d'un PAM (CyberArk)",
    hsItem5:
      "Développement de scripts pour automatiser et améliorer certains outils de cybersécurité",
    ...
    wlTitle3: ", Tours (37)",
    wlItem1:
      "Expérience du développement en Java sur un logiciel de paiement en ligne",
    wlItem2:
      "Animation d'une conférence sur les notions de cybersécurité et du pentest",
    ...
    synopsysItem1:
      "Pentesting : Applications Web & Mobile, Reverse-engineering, Embarqué",
    ...
    jeItem1:
      "Suivi et gestion de projet, intermédiaire entre les étudiants et les clients",
  ...
  en: {
    ...
    hsTitle2: ", Tours (37)",
    hsItem1:
      "Operational position for a cybersecurity team in EMEA (Europe, Middle-East et Africa)",
    hsItem2: "Technical support for a major international cyber crisis",
    hsItem3:
      "Security tools implementation and management (EDR, DLP, NAC, VMS...) for 6000+ endpoints",
    hsItem4:
      "Script development for automation and enhancement of cybersecurity tools",
    hsItem5:
      "Technical supervision and assistance for a PAM solution deployment (CyberArk)",
    ...
    wlItem2:
      "Cybersecurity conference on security concepts and pentesting, for the development teams",
    ...
    synopsysItem1:
      "Pentesting: Web & Mobile Applications, Reverse-engineering, Embedded",
    ...
    jeItem1:
      "Project monitoring, main intermediary between students and clients",
  ...
  return (
    <section>
      ...
      <a
        ...
        title={getText(source, "hsNavigate")}
      >
        ...
        <div className="title flex justify-between">
          ...
          <img
            src={isDarkMode ? henryscheinDarkLogo : henryscheinLogo}
            alt="Henry Schein logo"
            className="h-[0.65rem] mx-2 relative top-[0.08rem]"
          />
        </div>
        <ul>
      ...
      <a
        href="https://sips.worldline.com/fr/home.html"
        target="_blank"
        className="flex flex-col"
        title={getText(source, "wlNavigate")}
      >
      ...
      <a
        href="https://www.synopsys.com/software-integrity.html"
        target="_blank"
        className="flex flex-col"
        title={getText(source, "synopsysNavigate")}
      >
        ...
        <div className="title justify-between">
          ...
          <img
            src={synopsysLogo}
            alt="Synopsys logo"
            className="h-[0.85rem] mx-2 relative top-[0.2rem]"
          />
        </div>
        <ul>
      ...
      <a
        href="https://iris.insa-cvl.fr/"
        target="_blank"
        className="flex justify-between"
        title={getText(source, "jeNavigate")}
      >
        <div>
        ...
        <div className="flex gap-2">
          <img
            src={jeLogo}
            alt=""
            className="h-6 self-end justify-self-center relative -top-1 right-5"
          />
        </div>
      </a>
    </section>
